...
<body>
              ...
              <div class="media mb-4 p-3 bg-white shadow-sm">
                ...
                <div class="media-body">
                  ...
                  <div class="hotel-details mt-2" style="display: none;">
                      <p>W Barcelona está en Barcelona y tiene restaurante, bicicletas gratis, una terraza solárium con piscina y desayuno buffet. Este hotel de 5 estrellas ofrece spa con piscina cubierta y centro de fitness. El alojamiento dispone de recepción 24 horas, traslado para ir o volver del aeropuerto, servicio de habitaciones y wifi gratis en todo el alojamient</p>
                  </div>
              </div>
            </div>
            <div class="hotel-listing">
              <div class="media mb-4 p-3 bg-white shadow-sm">
                ...
                <div class="media-body">
                  ...
                  <div class="hotel-details mt-2" style="display: none;">
                      <p>Mandarin Oriental, Barcelona es un alojamiento muy bien situado en Barcelona que ofrece restaurante, centro de fitness y habitaciones con aire acondicionado. Ofrece jardín, terraza y bar. El alojamiento ofrece recepción 24 horas, servicio de habitaciones y cambio de moneda. Mandarin Oriental, Barcelona ofrece alojamiento de 5 estrellas con piscina cubierta y hammam.</p>
                  </div>
                </div>
              </div>
            </div>
        ...
        <aside class="col-sm-12 col-md-3 mb-3">
          ...
          <form id="client-area-form"  action="servidor.php" method="post">
            ...
            <div class="form-group">
              ...
              <select id="hotel-selector" name="hotel_selector" class="form-control" required>
                  <option value="WBarcelona">W Barcelona</option>
                  <option value="hotelMandarin">Hotel Mandarin Oriental</option>
              </select>
            </div>
            <div class="form-group">
  ...
  <script src="./static/src/show_details.js"></script>
